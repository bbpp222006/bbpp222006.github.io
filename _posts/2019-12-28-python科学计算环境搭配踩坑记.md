...
![](/mk_pic/mk-2019-12-28-14-19-23.png)这个选项要勾上，保证以后系统默认的 python 是 anaconda 内部的，方便以后管理。另一选项不用勾，英语好的可以自行分析。
...
使用方法:打开 anaconda prompt (`anaconda专用命令行,安装完后应该可以在开始菜单中找到`)
...
![](/mk_pic/mk-2019-12-28-20-08-37.png)
![](/mk_pic/mk-2019-12-28-20-09-20.png)
![](/mk_pic/mk-2019-12-28-20-10-03.png)  
